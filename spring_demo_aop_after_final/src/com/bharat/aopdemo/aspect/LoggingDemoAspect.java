...
public class LoggingDemoAspect {
	...
	public void afterThrowingExceptionAdvice(JoinPoint theJoinPoint, Throwable theExc) {
		...
		System.out.println("Aspect method  afterThrowingExceptionAdvice is catching the exception : " + theExc);
	}
	...
	public void afterFinallyAdvice(JoinPoint theJoinPoint) {
		String method = theJoinPoint.getSignature().toShortString();
		//System.out.println("\n\n-----method is : " + method);
		System.out.println("=========>LoggingDemoAspect: This is an afterFinallyAdvice method"); 
	}
}
